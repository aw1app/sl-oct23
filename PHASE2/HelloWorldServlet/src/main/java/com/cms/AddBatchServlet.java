...
public class AddBatchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.printf(" You Submitted BatchName = %s %s %s %s %s %s <br>", batchName, batchInstructor, batchStart,
				batchEnd, batchType, Arrays.toString(batchPrerquesties));
	 ...
	 * 
	 * String batchName = request.getParameter("batch-name"); String batchInstructor
	 * = request.getParameter("batch-instructor"); String batchStart =
	 * request.getParameter("batch-start"); String batchEnd =
	 * request.getParameter("batch-start"); String batchType =
	 * request.getParameter("batch-type");
	 * 
	 * out.println("<p> Thank you for adding a new batch!</p>");
	 * 
	 * out.printf(" You Submitted BatchName = %s %s %s %s %s <br>",batchName,
	 * batchInstructor,batchStart,batchEnd,batchType );
	 * 
	 * out.close(); }
	 */
