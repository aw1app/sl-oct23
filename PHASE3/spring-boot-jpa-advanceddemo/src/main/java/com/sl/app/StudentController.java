...
public class StudentController {
	...
	//ADVANCED REQ
	@GetMapping("/list-all-by-firstname")
	public String listAllStudentsHvaingFirstName(Model model, @RequestParam String firstName) {
	...
	@GetMapping("/list-all-whose-firstname-starts-with-a")
	public String abc(Model model) {
		List<Student> students = studentRepositry.findAllWhoseFirstNameStartsWithA();
